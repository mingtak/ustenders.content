...
CLASS_COD = [
['Product', 'Weapons', '10'],
['Product', 'Nuclear ordnance', '11'],
['Product', 'Fire control equipment', '12'],
['Product', 'Ammunition & explosives', '13'],
['Product', 'Guided missiles', '14'],
['Product', 'Aircraft & airframe structural components', '15'],
['Product', 'Aircraft components & accessories', '16'],
['Product', 'Aircraft launching, landing & ground handling equipment', '17'],
['Product', 'Space vehicles', '18'],
['Product', 'Ships, small craft, pontoons & floating docks', '19'],
['Product', 'Ship and marine equipment', '20'],
['Product', 'Railway equipment', '22'],
['Product', 'Ground effects vehicles, motor vehicles, trailers & cycles', '23'],
['Product', 'Tractors', '24'],
['Product', 'Vehicular equipment components', '25'],
['Product', 'Tires and tubes', '26'],
['Product', 'Engines, turbines & components', '28'],
['Product', 'Engine accessories', '29'],
['Product', 'Mechanical power transmission equipment', '30'],
['Product', 'Bearings', '31'],
['Product', 'Woodworking machinery and equipment', '32'],
['Product', 'Metalworking machinery', '34'],
['Product', 'Service and trade equipment', '35'],
['Product', 'Special industry machinery', '36'],
['Product', 'Agricultural machinery & equipment', '37'],
['Product', 'Construction, mining, excavating & highway maintenance equipment', '38'],
['Product', 'Materials handling equipment', '39'],
['Product', 'Rope, cable, chain & fittings', '40'],
['Product', 'Refrigeration, air conditioning & air circulating equipment', '41'],
['Product', 'Fire fighting, rescue & safety equipment', '42'],
['Product', 'Pumps & compressors', '43'],
['Product', 'Furnace, steam plant & drying equipment; & nuclear reactors', '44'],
['Product', 'Plumbing, heating, & sanitation equipment', '45'],
['Product', 'Water purification & sewage treatment equipment', '46'],
['Product', 'Pipe, tubing, hose & fittings', '47'],
['Product', 'Valves', '48'],
['Product', 'Maintenance & repair shop equipment', '49'],
['Product', 'Hand tools', '51'],
['Product', 'Measuring tools', '52'],
['Product', 'Hardware & abrasives', '53'],
['Product', 'Prefabricated structures and scaffolding', '54'],
['Product', 'Lumber, millwork, plywood & veneer', '55'],
['Product', 'Construction & building materials', '56'],
['Product', 'Communication, detection, & coherent radiation equipment', '58'],
['Product', 'Electrical and electronic equipment components', '59'],
['Product', 'Fiber optics materials, components, assemblies & accessories', '60'],
['Product', 'Electric wire & power & distribution equipment', '61'],
['Product', 'Lighting fixtures & lamps', '62'],
['Product', 'Alarm, signal & security detection equipment', '63'],
['Product', 'Medical, dental & veterinary equipment & supplies', '65'],
['Product', 'Instruments & laboratory equipment', '66'],
['Product', 'Photographic equipment', '67'],
['Product', 'Chemicals & chemical products', '68'],
['Product', 'Training aids & devices', '69'],
['Product', 'General purpose information technology equipment', '70'],
['Product', 'Furniture', '71'],
['Product', 'Household & commercial furnishings & appliances', '72'],
['Product', 'Food preparation and serving equipment', '73'],
['Product', 'Office machines, text processing systems & visible record equipment', '74'],
['Product', 'Office supplies and devices', '75'],
['Product', 'Books, maps & other publications', '76'],
['Product', 'Musical instruments, phonographs & home type radio', '77'],
['Product', 'Recreational & athletic equipment', '78'],
['Product', 'Cleaning equipment and supplies', '79'],
['Product', 'Brushes, paints, sealers & adhesives', '80'],
['Product', 'Containers, packaging, & packing supplies', '81'],
['Product', 'Textiles, leather, furs, apparel & shoe findings, tents & flags', '83'],
['Product', 'Clothing, individual equipment & insignia', '84'],
['Product', 'Toiletries', '85'],
['Product', 'Agricultural supplies', '87'],
['Product', 'Live animals', '88'],
['Product', 'Subsistence', '89'],
['Product', 'Fuels, lubricants, oils & waxes', '91'],
['Product', 'Nonmetallic fabricated materials', '93'],
['Product', 'Nonmetallic crude materials', '94'],
['Product', 'Metal bars, sheets & shapes', '95'],
['Product', 'Ores, minerals & their primary products', '96'],
['Product', 'Miscellaneous', '99',]]
...
['3252', 'Resin, Synthetic Rubber, and Artificial Synthetic Fibers and Filaments ManufacturingT'],
...
['53222', 'Formal Wear and Costume RentalT'],
['532220', 'Formal Wear and Costume Rental'],
['53223', 'Video Tape and Disc RentalT'],
['532230', 'Video Tape and Disc Rental'],
['53229', 'Other Consumer Goods RentalT'],
...
['7213', 'Rooming and Boarding HousesT'],
['72131', 'Rooming and Boarding HousesT'],
...
['8113', 'Commercial and Industrial Machinery and Equipment (except Automotive and Electronic) Repair and MaintenanceT'],
['81131', 'Commercial and Industrial Machinery and Equipment (except Automotive and Electronic) Repair and MaintenanceT'],
...
# NAICS_CODE
class ImportData(BrowserView):

    def __call__(self):

        portal = api.portal.get()

        for item in NAICS_CODE:
            obj = api.content.create(
                type='Naics',
                title=item[1],
                container=portal['naics'],
                naicsCode = item[0],
            )
            transaction.commit()
